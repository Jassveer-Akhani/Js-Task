function updateDays() {
    ...
    document.getElementById('ageShow').innerHTML = "<div class='boxes'><div class='box2'>Remaining Month :" + month + "</div></div><div class='boxes'>Remaining Days :" + days + "</div><div class='boxes'>Hour :" + hour + "</div><div class='boxes'>Min :" + min + "</div><div class='boxes'>Sec : " + sec + "</div>";
